...
function Student(){
  return(
    ...
    <div className="container my-4">
      ...
      <div className="card text-center text-bg-dark">
        <div className="card-body">
          <h5 className="card-title display-5 fw-bold ">Akova projects Hub</h5>
          <p className="card-text display-7 fw-bold">Find out latest projects!!</p>
          <p className="lead my-4">In this article: <br/>
              Top 10 Computer Science Project Topics of 2023<br/>
              Best Computer Science Project Ideas of 2023<br/>
              Innovative Project Ideas for Computer Science Student</p>
    ...
    <div className="row row-cols-1 row-cols-md-2 g-4 ">
      <div className="col">
          <div className="card h-100 idea-tab">
            ...
            <div className="card-body">
              ...
              <p className="card-text ">The project is about a drone controlled by AI.Which will reduce the human effort to operate the drones and saves lot of time and money....
                ...
                <Link to="/view1" className="btn btn-success mx-1">View More</Link>
                <Link to ="/upload"  className="btn btn-info mx-1">Upload IDEA</Link>
            </div>
          </div>
      </div>
      <div className="col">
        <div className="card h-100 idea-tab">
          ...
          <div className="card-body">
            ...
            <p className="card-text my-1">The biggest problem that students face when they join big 
              ...
              <Link to="/view2"  className="btn btn-success mx-1">View More</Link>
              <Link to ="/upload"  className="btn btn-info mx-1">Upload IDEA</Link>
          </div>
        </div>
      </div>
